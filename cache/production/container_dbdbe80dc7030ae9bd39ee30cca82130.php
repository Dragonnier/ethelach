...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000201cc23e00007f21ebe59144(
...
class phpbbtemplatetwiglexer_00000000201cc23e00007f21ebe59144 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a1adfbc9deb8783434505 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a1adfbc9dec3451290458 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a1adfbc9de95095446016 = array(
    ...
    {
        $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, 'set_environment', array('env' => $env), $this->initializer5a1adfbc9dec3451290458);

        return $this->valueHolder5a1adfbc9deb8783434505->set_environment($env);
    }
    ...
    {
        $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a1adfbc9dec3451290458);

        return $this->valueHolder5a1adfbc9deb8783434505->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a1adfbc9dec3451290458);

        return $this->valueHolder5a1adfbc9deb8783434505->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a1adfbc9dec3451290458 = $initializer;
    }
    ...
    {
        $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, '__get', array('name' => $name), $this->initializer5a1adfbc9dec3451290458);

        if (isset(self::$publicProperties5a1adfbc9de95095446016[$name])) {
            return $this->valueHolder5a1adfbc9deb8783434505->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a1adfbc9deb8783434505;
    ...
    {
        $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a1adfbc9dec3451290458);
    ...
    {
        $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, '__isset', array('name' => $name), $this->initializer5a1adfbc9dec3451290458);
    ...
    {
        $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, '__unset', array('name' => $name), $this->initializer5a1adfbc9dec3451290458);
    ...
    {
        $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, '__clone', array(), $this->initializer5a1adfbc9dec3451290458);

        $this->valueHolder5a1adfbc9deb8783434505 = clone $this->valueHolder5a1adfbc9deb8783434505;
    }

    public function __sleep()
    {
        $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, '__sleep', array(), $this->initializer5a1adfbc9dec3451290458);

        return array('valueHolder5a1adfbc9deb8783434505');
    }
    ...
    {
        return $this->initializer5a1adfbc9dec3451290458;
    }
    ...
    {
        return $this->initializer5a1adfbc9dec3451290458 && $this->initializer5a1adfbc9dec3451290458->__invoke($this->valueHolder5a1adfbc9deb8783434505, $this, 'initializeProxy', array(), $this->initializer5a1adfbc9dec3451290458);
    }
    ...
    {
        return null !== $this->valueHolder5a1adfbc9deb8783434505;
    }
    ...
    {
        return $this->valueHolder5a1adfbc9deb8783434505;
    }
